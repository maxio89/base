...
import com.project.test.mocks.ConversationMock;
...
// -------------------------- OTHER METHODS --------------------------
    ...
    {
        archive.addPackages(true, "com.project");
...
//        archive.addAsResource("business_pl.properties", "business_pl.properties");
    ...
    public WebArchive buildCITPackage()
    {
        ...
        archive.delete("WEB-INF/classes/com/project/web/SessionInvalidator.class");
    ...
    public WebArchive buildPackage()
    {
        return this.addAllLibraries()
            ...
            .setWebXML(new File("target/project/WEB-INF/web.xml"))
